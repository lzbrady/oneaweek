      ...
      .then(snapshot => {
        snapshot.forEach(child => {
          this.setState({
            ...
            latestBlogPreview: child.val().preview
          });
        });
      });
  }
      ...
      <div id="body pad-bottom">
        ...
        <div id="body-left-wrapper" className="feed-container">
          ...
          <p className="home-page-body-text">
            1 a Week is a charity-like organization which promotes positivity
            and mental health through acts of kindness. We ask everyone to
            perform good deeds and share them with us, in order to brighten the
            days and lives of those around them and visitors of this page! Just
            a 'smile' can potentially save someone's life. Imagine what impact
            you can have doing more!
          </p>
          ...
          <div className="blog-post-preview-wrapper-home">
            <a
              onClick={() =>
                history.push(`/blog/${this.state.latestBlogTitle}`)
              }
            >
              <h1 className="blog-post-preview-title-home">
                {this.state.latestBlogTitle}
              </h1>
              <p
                className="blog-post-preview-preview-home"
                dangerouslySetInnerHTML={{
                  __html: this.state.latestBlogPreview.replace(
                    /(<? *script)/gi,
                    "illegalscript"
                  )
                }}
